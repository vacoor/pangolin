...
| R4.2b-1 抽 SockLookup 纯函数类 | ⏳ 未开工 |
| R4.2b-2 抽 TcpStack(registries + 生命周期 + 全局策略) | ⏳ 未开工 |
| R4.2b-3 抽 SegmentDispatcher 外壳 + FSM switch | ⏳ 未开工 |
| R4.2b-4 处理方法下沉到 Sender / Receiver / Listener / TcpTimewaitSock | ⏳ 未开工 |
