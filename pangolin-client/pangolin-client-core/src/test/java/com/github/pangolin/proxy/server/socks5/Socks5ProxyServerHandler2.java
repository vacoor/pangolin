...
public class Socks5ProxyServerHandler2 extends ChannelInboundHandlerAdapter {
    ...
    public Socks5ProxyServerHandler2(final NioEventLoopGroup proxyWorksGroup) {
        this(null, null, proxyWorksGroup);
    }

    public Socks5ProxyServerHandler2(final String username, final String password, final NioEventLoopGroup proxyWorksGroup) {
