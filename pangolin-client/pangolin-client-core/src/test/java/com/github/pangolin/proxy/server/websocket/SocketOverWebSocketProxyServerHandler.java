 ...
 */
@Slf4j
public class SocketOverWebSocketProxyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    SocketOverWebSocketProxyServerHandler(NioEventLoopGroup proxyWorkersGroup, String websocketPath, String subprotocols, boolean allowExtensions, int maxFrameSize, boolean allowMaskMismatch) {
        this(proxyWorkersGroup, websocketPath, subprotocols, allowExtensions, maxFrameSize, allowMaskMismatch, false);
    }

    public SocketOverWebSocketProxyServerHandler(NioEventLoopGroup proxyWorkersGroup, String websocketPath, String subprotocols, boolean allowExtensions, int maxFrameSize, boolean allowMaskMismatch, boolean checkStartsWith) {
