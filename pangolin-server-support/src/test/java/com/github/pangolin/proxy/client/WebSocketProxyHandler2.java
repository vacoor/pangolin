 ...
 */
@Slf4j
public class WebSocketProxyHandler2 extends WsProxyHandler {
    ...
    public WebSocketProxyHandler2(final URI webSocketProxyServerEndpoint, final String webSocketProxyServerProtocol) {
        this(webSocketProxyServerEndpoint, WebSocketVersion.V13, webSocketProxyServerProtocol, true, 65536, true, true);
    }

    public WebSocketProxyHandler2(final URI webSocketProxyServerEndpoint,
...
//            throw new IllegalStateException("ChannelPipeline does not contain " + "a HttpObjectAggregator");
    ...
    @Override
    public void handshake(final ChannelHandlerContext ctx) throws Exception {
        ...
        handshaker.handshake(new CtxWriteDelegatingChannel(ctx)).addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture future) throws Exception {
                if (!future.isSuccess()) {
                    handshakeAbort(ctx, future.cause());
                }
            }
        });
