...
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.DarwinUtils.throwLastErrorException;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.DarwinUtils.toInet4Address;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.DarwinUtils.toInet6Address;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.DarwinUtils.writeSockAddr4;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.DarwinUtils.writeSockAddr6;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.ND6_INFINITE_LIFETIME;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Socket.AF_INET;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Socket.AF_INET6;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Socket.AF_UNSPEC;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Socket.SOCK_DGRAM;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCAIFADDR;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCAIFADDR_IN6;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCDIFADDR;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCDIFADDR_IN6;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCGIFADDR;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCGIFDSTADDR;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCGIFMTU;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCGIFNETMASK;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCSIFADDR;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCSIFDSTADDR;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCSIFMTU;
import static com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.Sockio.SIOCSIFNETMASK;
...
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If;
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.ifaddrs;
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.ifaliasreq;
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.ifreq;
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.in6_aliasreq;
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.sockaddr_in;
import com.github.pangolin.routing.acceptor.tun.adapter.darwin.jna.If.sockaddr_in6;
...
public class DarwinNetworkInterface extends UnixNetworkInterface implements NetworkInterfaceEx {
     ...
     */
    public static int getMTU0(final String ifname) {
        final int fd = fd4();
        try {
     ...
     * @param mtu    the value of the MTU for that interface.
     */
    public static void setMTU0(final String ifname, final int mtu) {
        final int fd = fd4();
        try {
