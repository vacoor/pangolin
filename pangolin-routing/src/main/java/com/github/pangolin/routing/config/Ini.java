...
public final class Ini implements Map<String, Ini.Section> {
    ...
    private void addSection(String name, StringBuilder content) {
        if (content.length() > 0) {
            ...
            String cleaned = clean(contentString);
            if (cleaned != null) {
    ...
    protected static String clean(final String line) {
        String lineToUse = null != line ? line.trim() : line;
        return !lineToUse.isEmpty() ?  lineToUse : null;
    }
    ...
    public static final class Section implements Map<String, String> {
        ...
        private Section(String name, String sectionContent) {
            ...
            if (StringUtils2.hasText(sectionContent)) {
        ...
        protected static String[] splitKeyValue(String keyValueLine) {
            String line = clean(keyValueLine);
            if (line == null) {
                return null;
            }
            ...
            String key = clean(keyBuffer.toString());
            String value = clean(valueBuffer.toString());
            ...
            */
            if (key == null) {
                String msg = "Line argument must contain a key.  Only one string token was found.";
                throw new IllegalArgumentException(msg);
            }
