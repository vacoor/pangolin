...
public interface inet_connection_sock_af_ops {
    ...
    void send_check(final Channel net, TcpSock sk, final IpPacketBuf pkt);

    tcp_request_sock conn_request(final Channel net, TcpSock listenSock, final IpPacketBuf pkt);

    TcpSock syn_recv_sock(final Channel net, TcpSock listenSock, final IpPacketBuf pkt, tcp_request_sock req);
