...
public class SysctlOptions {
  ...
  public static final boolean ipv4_sysctl_tcp_window_scaling = true;
  public static final int ipv4_sysctl_tcp_pingpong_thresh = 1;
  ...
  public static final int ipv4_sysctl_tcp_keepalive_probes = 9;
  public static final int ipv4_sysctl_tcp_keepalive_time = 7200 * HZ;
  public static final int ipv4_sysctl_tcp_keepalive_intvl = 75 * HZ;

  public static final int ipv4_sysctl_tcp_fin_timeout = 60 * HZ;
