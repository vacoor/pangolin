...
public class Tcp4Multiplexer extends TcpMultiplexer {
    ...
    protected tcp_request_sock tcp_v4_conn_request(ChannelHandlerContext net, TcpSock listenSock, TcpPacketBuf pkt) {
        ...
        tcp_request_sock req = new tcp_request_sock(FourTuple.of(pkt), listenSock, handshaker);
     ...
     */
    private static void tcp_openreq_init(tcp_request_sock req, TcpHandshaker handshaker, TcpPacketBuf pkt) {
