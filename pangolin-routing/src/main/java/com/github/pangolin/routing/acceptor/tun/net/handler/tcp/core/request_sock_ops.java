...
public interface request_sock_ops {
    ...
    void send_ack(final Channel net, final TcpSock sk, final IpPacketBuf pkt, final request_sock req);

    void send_reset(final Channel net, final TcpSock sk, final IpPacketBuf pkt, final int reason);
