 ...
 *
 */
public class HttpUpstreamServerFactory implements UpstreamServerFactory {
    ...
    public UpstreamServer create(final String url, final Properties props) {
        ...
        if (null != userInfo) {
            ...
            return new HttpUpstreamServer(name, address, username, password);
        }

        return new HttpUpstreamServer(name, address, null, null);
    }
     ...
     *
     */
    private class HttpUpstreamServer extends AbstractUpstreamServer {
        private final SocketAddress address;
        private final String username;
        private final String password;

        public HttpUpstreamServer(final String name, final SocketAddress address, final String username, final String password) {
            super(name);
