 ...
 *
 */
public class SubnetRoutePredicate implements RoutePredicate {
    private final InetAddress ipAddress;
    private final int prefixLength;
    private final RoutePredicate delegate;
    private volatile InetAddress networkAddress;

    public SubnetRoutePredicate(final String ipAddress, final int cidrPrefix) {
        try {
    ...
    public RoutePredicate getDelegate() {
        return delegate;
    }
    ...
    public static class Inet4SubnetPattern implements RoutePredicate {
    ...
    public static class Inet6SubnetPattern implements RoutePredicate {
