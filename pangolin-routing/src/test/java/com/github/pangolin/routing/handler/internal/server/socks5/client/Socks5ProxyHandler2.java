 ...
 *
 */
public class Socks5ProxyHandler2 extends AbstractProxyHandler {
    ...
    public Socks5ProxyHandler2(final SocketAddress proxyServerAddress) {
    ...
    private Socks5CommandRequest createConnectRequest(final InetSocketAddress raddr) throws Exception {
        ...
        return new DefaultSocks5CommandRequest(Socks5CommandType.UDP_ASSOCIATE, addrType, rhost, raddr.getPort());
    }
}
