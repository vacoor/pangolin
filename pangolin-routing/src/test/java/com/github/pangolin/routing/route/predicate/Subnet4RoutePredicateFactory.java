...
public class Subnet4RoutePredicateFactory implements RoutePredicateFactory<Inet4Address, String> {
     ...
     */
    @Override
    public RoutePredicate<Inet4Address> apply(final String definition) {
        ...
        return new Subnet4RoutePredicate(ipAddress, cidrPrefix);
    }
    ...
    public static void main(String[] args) {
        RoutePredicate<Inet4Address> apply = new Subnet4RoutePredicateFactory().apply("192.168.1.1");
