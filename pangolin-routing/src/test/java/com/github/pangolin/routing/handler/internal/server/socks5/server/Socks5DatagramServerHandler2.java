 ...
 */
@Slf4j
public class Socks5DatagramServerHandler2 extends ChannelInboundHandlerAdapter {
    ...
    public Socks5DatagramServerHandler2(final InetSocketAddress owner, final DatagramChannelFactory datagramChannelFactory) {
        this.owner = owner;
    ...
    public void handlerRemoved(final ChannelHandlerContext ctx) throws Exception {
        for (ChannelFuture cf : natMap.values()) {
            cf.channel().close();
        }
