...
public final class WindowsTunDevice extends AbstractTunDevice {
    ...
    private WindowsTunDevice(final Wintun.WINTUN_ADAPTER_HANDLE adapter,
                             final Wintun.WINTUN_SESSION_HANDLE session,
...
//                final IntByReference packetSizePointer = new IntByReference();
    ...
    public void writePacket(final ByteBufAllocator alloc, final TunPacket msg) throws IOException {
        ...
        final WinDef.DWORD packetSize = new WinDef.DWORD(msg.content().readableBytes());
