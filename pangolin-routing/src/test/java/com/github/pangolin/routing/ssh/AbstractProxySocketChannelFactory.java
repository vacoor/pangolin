 ...
 */
@Slf4j
public abstract class AbstractProxySocketChannelFactory implements SocketChannelFactory {
    ...
    protected abstract ChannelHandler select(final SocketAddress destinationAddress);
